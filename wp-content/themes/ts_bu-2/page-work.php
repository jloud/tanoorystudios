...
<button class="illustrations" data-filter=".illustrations">Illustration</button>
</div>
...
<div class="work-page">
	...
	<?php while ($query_cat->have_posts()) : $query_cat->the_post(); ?>
		<div class="thumb <?php foreach((get_the_category()) as $category) { 
			...
			<a href="<?php the_permalink(); ?>"><span class="work-title"><?php the_title(); ?></span><?php the_post_thumbnail();?></a>
