...
access_token:'CAACEdEose0cBAMOOZAaUGghxvuUAhqJjeitFjuU3MVlAkg76EbaMWZAVLMkeb7gSwroTvWdPY99fpaE6eZCB7rTbxt6NgeQog62BciLF2mewkX8r6XIAuwXbjMWRoW300rI12As7txFlD8BhNMrgbWpDOz9uy4aQwvpAHZB1KZBjZAQZAPHsNhPZCIcNJ2UZAv4ZA9lepzkhVN8AZDZD'
    ...
    $('.gallery').cycle({
    	...
    	pagerTemplate: '<a href="#" ><img src="{{children.0.src}}"></a>',
    	timeout: 0,
    	centerHorz: true,
	    speed: 600,
			manualSpeed: 100  
    ...
    /*frontholder.imagesLoaded(function() {
	    frontholder.masonry({
	      isFitWidth: true,
	      gutter: 60,
				itemSelector: '.front-thumb'
		});*/
  ...
  function smartresize() {
    ...
    if ( currentColumns !== columns ) {
      ...
      thumbholder.width( columns * colW )
        .isotope('reLayout');
    }
  }

  $(window).smartresize(); // trigger resize to set container width
